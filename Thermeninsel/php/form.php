...
<div class="content">
    ...
    <header class="header">
        ...
        <nav aria-label="Navigation" class="navbar" role="navigation">
            ...
            <div class="navbar-menu" id="navMenu" role="menubar" aria-label="Navigation">
                <div class="navbar-start">
                    <a role="menuitem" href="index.html" tabindex="0" lang="en" class="navbar-item">
                        Home
                    </a>
                    <a role="menuitem" href="about.html" tabindex="0" class="navbar-item">
                        Über uns
                    </a>
                    <a role="menuitem" href="shop.html" tabindex="0" class="navbar-item">
                        Sortiment
                    </a>
                    <a role="menuitem" href="request.html" tabindex="0" class="navbar-item">
                        Anfragen
                    </a>
                    <a role="menuitem" href="coffee.html" tabindex="0" class="navbar-item">
                        Kaffee
                    </a>
                    <a role="menuitem" href="contact.html" tabindex="0" class="navbar-item">
                        Kontakt
                    </a>
                </div>
    ...
    <div id="main" class="has-text-centered">
        ...
        <div>
            ...
            <p class="text">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor
                ...
                dolores et ea rebum. Stet clita kasd gubergren, no sea takimata est Lorem ipsum dolor sit amet.<br>

                Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut
                labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et et ea rebum. Stet clita kasd, no
                sea takimata est Lorem ipsum sit amet.<br>

                Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy voluptua. At vero eos et
    ...
    <footer>
        <div class="level">
            <div class="level-item has-text-centered">
                <div>
                    <p >Adresse</p>
                    <p >Kurallee 1, 94072 Bad Füssing</p>
                </div>
            </div>
            <div class="level-item has-text-centered">
                <div>
            ...
            <div class="level-item has-text-centered">
                <div>
                    <a href="https://www.facebook.com/" title="Facebook">
                        <img src="images/facebook.png" alt="" width="1.8%">Facebook
                    </a>
                </div>
            </div>
            <div class="level-item has-text-centered">
                <div>
                    <p id="agb">
                        <a role="menuitem" href="agb.html" tabindex="0">AGB</a>
                    </p>
                </div>
            </div>
            <div class="level-item has-text-centered">
                <div>
                    <p id="datenschutz">
                        <a role="menuitem" href="datenschutz.html" tabindex="0">Datenschutzerklärung</a>
                    </p>
                </div>
            </div>
            <div class="level-item has-text-centered">
                <div>
                    <p id="impressum">
                        <a role="menuitem" href="impressum.html" tabindex="0">Impressum</a>
                    </p>
                </div>
            </div>
            <div class="level-item has-text-centered">
                <div>
                    <p id="sitemap">
                        <a role="menuitem" href="sitemap.html" tabindex="0" lang="en">Sitemap</a>
                    </p>
                </div>
            </div>
        </div>
...
<!-- Javascript -->
<link rel="script" type="text/javascript" href="JS/Navigation.js">
